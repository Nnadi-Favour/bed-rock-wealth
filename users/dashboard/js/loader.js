...
(()=>{
    var t = {
        ...
        412: (t,e,n)=>{
            ...
            function l(t, e) {
                ...
                u._immediateFn((function() {
                    ...
                    if (null !== n) {
                        ...
                        (1 === t._state ? p : d)(e.promise, t._value)
                }
                ))) : t._deferreds.push(e)
            }
            function p(t, e) {
            ...
            "function" != typeof w.Promise ? w.Promise = v : (w.Promise.prototype.finally || (w.Promise.prototype.finally = r),
            w.Promise.allSettled || (w.Promise.allSettled = o))
        }
        ,
        42: (t,e,n)=>{
            "use strict";
            ...
            var r = n(521)
              ...
              , s = function() {
                ...
                t.prototype.create = function(t, e, n, s) {
                    ...
                    o.request)("".concat(c.bootstrapUrl, "/widget/").concat(c.key, ".json")).then((function(t) {
                        var n = (0,
                        o.parseJSON)(t);
                        return delete e.features,
                        u.init((0,
                        o.mergeDeep)(n, e), n.features),
                        e && e.widgetTrackerEnabled && 3 === e.widgetVersion && (0,
                ...
                t.prototype.createWidget = function(t, e, n) {
                    ...
                    return a(c),
                    (0,
                    o.request)("".concat(c.bootstrapUrl, "/widget/").concat(c.key, ".json")).then((function(a) {
                        var u = (0,
                        o.parseJSON)(a)
            ...
            e.trackOperation = function(t, e) {
                return r(this, void 0, void 0, (function() {
                    return o(this, (function(n) {
                        switch (n.label) {
                        case 0:
                            if (!t.widgetTrackerUrl || s.indexOf(e) >= 0 || a.indexOf(window.location.hostname) >= 0)
                                return [2, !1];
                            n.label = 1;
                        case 1:
                            return n.trys.push([1, 3, , 4]),
                            [4, (0,
                            i.request)(t.widgetTrackerUrl + "/track/operation?key=".concat(t.key, "&operation=").concat(e, "&domain=").concat(window.location.hostname))];
                        case 2:
                            return n.sent(),
                            [2, !0];
                        case 3:
            ...
            e.trackOptions = function(t, e) {
                return r(this, void 0, void 0, (function() {
                    ...
                    return o(this, (function(r) {
                        switch (r.label) {
                        case 0:
                            if (!t.widgetTrackerUrl || a.indexOf(window.location.hostname) >= 0)
                                return [2, !1];
                        ...
                        case 1:
                            ...
                            [4, (0,
                            i.request)(t.widgetTrackerUrl + "/track/options?key=".concat(t.key, "&options=").concat(n.join(","), "&domain=").concat(window.location.hostname))];
                        case 2:
                            return r.sent(),
                            [2, !0];
                        case 3:
            ...
            var i = n(521)
              ...
              , l = function() {
                ...
                t.prototype.createContainer = function() {
                    ...
                    this.options.zIndex && (t.style.zIndex = "".concat(this.options.zIndex + 1)),
                ...
                t.prototype.createFrame = function() {
                    ...
                    return t.id = "".concat(this.id).concat(u),
                ...
                t.prototype.createFrameV2 = function() {
                    ...
                    return t.setAttribute("style", "width: 100%; height: 100%; border: none; position: absolute; left: 0"),
                    this.options.zIndex && (t.style.zIndex = "".concat(this.options.zIndex + 1)),
                    t
                }
                ,
                    ...
                    return r(this, void 0, void 0, (function() {
                        return o(this, (function(e) {
                            ...
                            case 1:
                                ...
                                e.label = 2;
                            case 2:
                                return 3 === this.options.widgetVersion ? this.renderV3(t) : this.renderV2(t),
                                [2]
                            }
                        }
                        ))
                ...
                t.prototype.renderV2 = function(t) {
                    if (!document.getElementById(this.id + c)) {
                        ...
                        !t && this.options.renderTo && (t = this.options.renderTo),
                    ...
                    i.addEventListener("load", (function() {
                        ...
                        r(n, void 0, void 0, (function() {
                            ...
                            return o(this, (function(e) {
                                ...
                                case 0:
                                    return [4, (0,
                                    s.request)("".concat(this.getBaseUrl(), "/asset-manifest.json")).then((function(t) {
                                        return (0,
                                        s.parseJSON)(t)
                                    }
                                    ))];
                                case 1:
                                    return e.sent().entrypoints.forEach((function(e) {
                                        var n = (0,
                                        s.createScript)(a, t.getBaseUrl() + "/".concat(e));
                                        c.appendChild(n)
                                    }
                                    )),
                                    [2]
                ...
                t.prototype.renderFrameV3 = function(t) {
                    ...
                    n.addEventListener("load", (function() {
                        ...
                        var l = "src/main.ts"
                          , p = function(t) {
                            var n = (0,
                            s.createScript)(a, e.getBaseUrl() + "/".concat(t));
                            n.type = "module",
                            c.appendChild(n)
                        }
                          , d = function(t) {
                            var n = (0,
                            s.createLink)(a, "".concat(e.getBaseUrl(), "/").concat(t));
                            n.rel = "stylesheet",
                        ...
                        !0 === e.options.widgetV3DevMode ? ["@vite/client", l].forEach(p) : r(e, void 0, void 0, (function() {
                            ...
                            return o(this, (function(o) {
                                ...
                                case 0:
                                    return [4, (0,
                                    s.request)("".concat(this.getBaseUrl(), "/manifest.json")).then((function(t) {
                                        return (0,
                                        s.parseJSON)(t)
                                    }
                                    ))];
                                case 1:
                                    ...
                                    null === (r = n.imports) || void 0 === r || r.forEach((function(n) {
                                        ...
                                        r = t[n].file,
                                        (o = (0,
                                        s.createLink)(a, "".concat(e.getBaseUrl(), "/").concat(r))).rel = "modulepreload",
                                        c.appendChild(o)
                                    }
                                    )),
                                    null === (i = n.css) || void 0 === i || i.forEach(d),
                                    d(t["style.css"].file),
                                    [2]
                                }
                            }
                ...
                t.prototype.installApi = function(t) {
                    ...
                    this._pushApi && (this._pushApi.forEach((function(n) {
                        ...
                        try {
                            e.options.widgetTrackerEnabled && 3 === e.options.widgetVersion && (0,
