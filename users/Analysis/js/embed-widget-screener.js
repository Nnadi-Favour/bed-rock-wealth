    ...
    (()=>{
        ...
        new class extends class {
            ...
            filterRawSettings(t) {
                const e = {}
                  , r = Object.keys(t)
                  , i = new Set(this.propertiesToWorkWith);
                return r.forEach((r=>{
                    i.has(r) && (e[r] = t[r])
                }
                )),
            ...
            _replaceScript(e) {
                const {scriptEnv: r, scriptURL: n, scriptElement: s, rawSettings: a, id: l} = e
                  , c = s.parentNode
                ...
                this.iframeContainer.appendChild(b);
            ...
            _iframeSrcBase(t, e) {
                let r = `${this._iframeSrcHost(t, e)}/embed-widget/${this.widgetId}/`;
                return this.settings.customer && -1 !== this.propertiesToSkipInHash.indexOf("customer") && (r += `${this.settings.customer}/`),
                r
            }
            _iframeSrcHost(t, e) {
                ...
                if ("battle" === e)
                    return r;
                const i = t.host.includes("beta.tradingview.com") || t.host.includes("betacdn.tradingview.com");
                return "staging" === e && i ? "https://www.xstaging-widget.tv" : ["staging", "local"].includes(e) ? `${t.protocol}//${t.host}` : r
            }
            _validateSettings() {
                const t = (t,e)=>{
                    if (void 0 === t)
            ...
            _setHashString(t, e) {
                ...
                (this.useParamsForConnectSocket || this.useSnowplowPageView) && (r["page-uri"] = h());
            ...
            _createIframe(t, e, r, i, n, s) {
                ...
                o.style.height = t,
                o.style.width = "100%";
                const a = new URL(this._iframeSrcBase(e, r));
                return this._setSettingsQueryString(a),
                this._setHashString(a, i),
                    ...
                    if (i) {
                        ...
                        if (n)
                            try {
                                ...
                                s.searchParams.set("utm_campaign", r),
                                i.setAttribute("href", s.toString())
                            } catch (t) {
